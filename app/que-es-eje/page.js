      ...
      <section>
        <div className="container" style={{maxWidth: '900px'}}>
          ...
          <ul className="lista-eje">
            <li>Detecta respuestas que se repiten y que la persona quizá no estaba viendo con claridad.</li>
            <li>Diferencia una obligación real de una carga asumida automáticamente.</li>
            <li>Ayuda a identificar cuándo puede existir un límite, una negociación, una prioridad distinta o un pedido de ayuda.</li>
            <li>Permite observar el costo de seguir respondiendo siempre de la misma manera.</li>
